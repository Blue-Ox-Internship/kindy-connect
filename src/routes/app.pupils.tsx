...
function PupilsPage() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      } as Omit<Pupil, "id" | "active"> & {
        parent: { name: string; phone: string; email: string; relationship: string };
      });
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-4">
            ...
            <Dialog open={open} onOpenChange={setOpen}>
              ...
              <DialogContent className="max-h-[90vh] flex flex-col overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-3 pr-2 overflow-y-auto flex-1">
